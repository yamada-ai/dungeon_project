...
class Dungeon:
    ...
    def print_floor_map(self):
        color_format = ('\033[47m  \033[0m', '\033[41m  \033[0m', '\033[44m  \033[0m', '\033[42m  \033[0m', '\033[48m  \033[0m')
...
if __name__ == "__main__":
    ...
    row = 30
    column = 40
    d = Dungeon(row, column)
    d._div_floor(0, 0, row, column)
    for room in d.room_info:
        print(room)
    print()
    d._make_rooms()
    d.scaling()
